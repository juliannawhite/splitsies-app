...
export default function Header(props) {
  ...
  return (
      ...
      <div className="header">
          ...
          {props.numItems != 0 && <button id = "itemToggleButton" onClick={toggleItemized}><i className={`fa-solid fa-toggle-${props.isItemized ? "off":"on"}`}title="Add Item"></i><span className="hideText">itemized</span></button>}
